...
gmt begin
	...
	gmt grdclip dem.nc -Gabove.nc -Sr0/-1
gmt end
EOF
...
gmt begin
	...
	gmt grdview above.nc -Rabove.nc -Ca.cpt -Qi${MOVIE_DPU} -Iintens.nc -JM19c -JZ0.4c -p-${MOVIE_COL0}/35+v4.5c/1.7c -X7.6c -Y5c
