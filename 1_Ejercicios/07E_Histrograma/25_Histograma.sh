...
#	Otros ejes secundarios
	gmt histogram U-PB_Ages.txt -J$PROJ -Z$Z -T$T -Byafg+l"Frecuencia (\045)" -Bx500f100 -Gorange -B+glightblue -Bsxc"Eje/Eras_Geologicas2.txt"+l"Eras (Ma)" -W -l"Edades U-Pb"
