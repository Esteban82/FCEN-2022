...
#	-----------------------------------------------------------------------------------------------------------
#	Titulo del mapa
	title=45_AireLibre_Dem_TALUD
    #title=45_AireLibre_Dem_TALUD
	echo $title

#	Region: Sudamerica y Atlantico Sur
#	REGION=-72/-64/-35/-30
	REGION=-57/-56/-40.5/-40
...
#	gmt grdimage $CUT -I
    ...
    gmt grdcontour $GRD -C10 -A

#	Agrega escala de colores. (-E triangles). Posicion (-D) (horizontal = h)
	gmt colorbar -DJRM+o0.4/0+w90%/0.618c+e -Ba20+l"Anomal\355as Aire Libre (mGal)" -I
