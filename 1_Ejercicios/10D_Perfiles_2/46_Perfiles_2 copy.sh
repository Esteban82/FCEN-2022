...
#	Dibujar Eje Y y datos de columnas 3a y 4a (-i2,3)
	...
	gmt basemap -R0/$KM/$Topo -Byag+l"Elevaciones (m)"              -BEwsn --FONT_ANNOT_PRIMARY=8,Helvetica,blue


	gmt plot -R0/$KM/$Grav tmp_data -W0.5,red  -i2,4 -Yh

#	Dibujar Ejes de datos
	gmt basemap -R0/$KM/$Grav -Bya+l"Anomal\355a Aire Libre (mGal)" -BEwsn --FONT_ANNOT_PRIMARY=8,Helvetica,red
