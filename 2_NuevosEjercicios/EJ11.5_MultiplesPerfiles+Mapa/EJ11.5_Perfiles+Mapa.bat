...
REM	Titulo del mapa
	SET	title=EJ11.5_Perfiles+Mapa
	echo %title%

	SET	DEM=GMRTv3_5.grd

REM	Region: Argentina
	SET	REGION=-88/-18/-56.5/15
	SET	REGION=-88/-18/-57/15
	
REM	Proyeccion Mercator (M)
	SET	PROJ=M15c
rem	SET	PROJ=S-53/-21/45/15c
rem	SET	PROJ=S-65/-30/90/15c
	SET	GRA="E:\Facultad\Datos_Geofisicos\Gravimetria\Sandwell-Smith\Datos\grav_29.1.img"
...
rem	gmt grdtrack "Trench_PlateProject.txt" -G%TGRA% -C5000k/50k/200k+v > "temp_data"
