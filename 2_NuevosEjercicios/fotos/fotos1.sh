...
montage -geometry +12+12 -tile 4x2 fotos/*.jpg montage.jpg
...
#montage fotos/*.jpg -thumbnail 300x300 -set caption %t -background grey40 -pointsize 9 -density 144x144 +polaroid -resize 50%  -background white -geometry +1+1 -tile 4x4 -title "Las fotos de mi tesis" polaroid_t.jpg
